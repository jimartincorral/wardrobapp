const es = {
  ...
  addGarment: {
    ...
    analyzePhoto: 'Detectar Colores',
    analyzingPhoto: 'Leyendo colores de la foto...',
    labels: {
      photos: 'Fotos *',
      category: 'Categoría *',
      type: 'Tipo',
  ...
  settings: {
    ...
    alerts: {
      ...
      restoringHint: 'Puede tardar un rato en copias grandes. Mantén la app abierta.',
      restored: 'Restaurado',
      restoredMsg: 'Copia restaurada. Recarga ahora para ver tu armario restaurado.',
  ...
  subcategories: {
    ...
    jacket: 'Chaqueta', coat: 'Abrigo', blazer: 'Blazer', overshirt: 'Sobrecamisa', cardigan: 'Cardigan', vest: 'Chaleco', poncho: 'Poncho', cape: 'Capa', windbreaker: 'Rompevientos', parka: 'Parka',
    sneakers: 'Tenis', boots: 'Botas', sandals: 'Sandalias', heels: 'Tacones', flats: 'Flats', loafers: 'Mocasines', athletic: 'Deportivo',
    hat: 'Sombrero', scarf: 'Bufanda', foulard: 'Fular', belt: 'Cinturon', bag: 'Bolso', wallet: 'Cartera', gloves: 'Guantes', jewelry: 'Joyeria', watch: 'Reloj', sunglasses: 'Gafas de sol', tie: 'Corbata',
