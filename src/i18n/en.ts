const en = {
  ...
  home: {
    ...
    actions: {
      ...
      statistics: 'Statistics',
      statisticsDesc: 'Counts by category & color',
    },
  },
  ...
  statistics: {
    title: 'Statistics',
    subtitle: 'How your wardrobe breaks down',
    openButton: 'View detailed statistics',
    ...
    noSubcategory: 'Unspecified',
    tapToExpand: 'Tap a category to see subcategories',
    sortByCount: 'Count',
    sortByName: 'A–Z',
    empty: 'Add garments to see statistics.',
  },
  ...
  addGarment: {
    ...
    analyzePhoto: 'Detect Colors',
    analyzingPhoto: 'Reading colors from photo...',
    labels: {
      photos: 'Photos *',
      category: 'Category *',
      type: 'Type',
  ...
  settings: {
    ...
    restoreFromFileHint: 'Pick a backup .zip from your device — useful for restoring a backup shared from another phone.',
    delete: 'Delete',
    optimizeStorage: 'Optimize Image Storage',
    optimizeStorageHint: 'Shrinks older background-removed images that were saved at full resolution. Safe to run anytime.',
    aboutTitle: 'About',
    version: 'Version',
    framework: 'Framework',
    ...
    alerts: {
      ...
      restoreFileMsg: 'Choose a backup file to restore. This will replace all current data.',
      restoreConfirm: 'Restore',
      restoring: 'Restoring backup…',
      restoringHint: 'This can take a while for large backups. Please keep the app open.',
      restored: 'Restored',
      restoredMsg: 'Backup restored. Reload now to see your restored wardrobe.',
      ...
      deletedMsg: 'The backup has been deleted.',
      deleteFailed: 'Delete Failed',
      deleteFailedMsg: 'Could not delete this backup.',
      optimizeDone: 'Storage Optimized',
      optimizeDoneMsg: 'Recompressed %{count} image(s), freeing %{mb} MB.',
      optimizeNone: 'Nothing to Optimize',
      optimizeNoneMsg: 'All images are already optimized.',
      optimizeFailed: 'Optimization Failed',
      optimizeFailedMsg: 'Could not optimize image storage.',
      cancel: 'Cancel',
    },
  },
  ...
  subcategories: {
    ...
    jacket: 'Jacket', coat: 'Coat', blazer: 'Blazer', overshirt: 'Overshirt', cardigan: 'Cardigan', vest: 'Vest', poncho: 'Poncho', cape: 'Cape', windbreaker: 'Windbreaker', parka: 'Parka',
    sneakers: 'Sneakers', boots: 'Boots', sandals: 'Sandals', heels: 'Heels', flats: 'Flats', loafers: 'Loafers', athletic: 'Athletic',
    hat: 'Hat', scarf: 'Scarf', foulard: 'Foulard', belt: 'Belt', bag: 'Bag', wallet: 'Wallet', gloves: 'Gloves', jewelry: 'Jewelry', watch: 'Watch', sunglasses: 'Sunglasses', tie: 'Tie',
