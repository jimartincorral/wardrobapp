const en = {
  ...
  subcategories: {
    ...
    jacket: 'Jacket', coat: 'Coat', blazer: 'Blazer', cardigan: 'Cardigan', vest: 'Vest', windbreaker: 'Windbreaker', parka: 'Parka',
    ...
    bra: 'Bra', briefs: 'Briefs', boxers: 'Boxers', bodysuit: 'Bodysuit', socks: 'Socks', tights: 'Tights', thermal: 'Thermal',
